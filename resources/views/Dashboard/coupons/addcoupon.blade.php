...
@section('content')
    <div class="container mt-5">
        <h3 class="mb-4">إضافة كوبون جديد</h3>
        ...
        <form action="{{ route('admin.storecoupon') }}" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <select name="type" id="type" class="form-control" required>
                    ...
                    <option value="1" {{ old('type') == 'fixed' ? 'selected' : '' }}>خصم ثابت</option>
                    <option value="2" {{ old('type') == 'percent' ? 'selected' : '' }}>خصم بنسبة مئوية</option>
                </select>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input type="number" name="min_purchase" id="min_purchase" step="0.01" class="form-control"
